...
const ProjectsCard = ({ projects, containerClass, href }) => {
  ...
  return (
    <div className={defaultClass}>
      ...
      <div className="absolute left-0 top-0 z-20 space-y-3 p-5">
        ...
        />
        <Paragraph className="text-sm !text-[#F8F9FD]">
          {projects?.location[currentLang]},
          {projects?.department?.name?.[currentLang]}
        </Paragraph>
        ...
        <HyperLink
          ...
          href={
            href || `/projects/${projects?.department?.href}/${projects?._id}`
          }
        >
          {t("home.view_more")}
        </HyperLink>
